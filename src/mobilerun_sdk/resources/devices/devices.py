...
from .esim.esim import EsimResource, AsyncEsimResource, EsimResourceWithRawResponse, AsyncEsimResourceWithRawResponse, EsimResourceWithStreamingResponse, AsyncEsimResourceWithStreamingResponse
...
from ..._utils import maybe_transform, path_template, strip_not_given, is_given, async_maybe_transform

from ..._base_client import make_request_options

from typing_extensions import Literal

from ..._types import Omit, omit, SequenceNotStr, NotGiven, not_given
...
from ...types import device_create_params

from typing_extensions import Literal, overload
from ..._types import Timeout, Headers, NotGiven, not_given, Omit, omit, NoneType, Query, Body
from ...types import device_create_params
from ...types import device_list_params
from ...types import device_set_name_params
from ...types import device_terminate_params
...
class DevicesResource(SyncAPIResource):
    ...
    *,
    ...
    device_type: Literal["android_cloud_phone", "dedicated_premium_device", "dedicated_physical_device", "dedicated_ios_device", "dedicated_emulated_device"] | Omit = omit,
    ...
    timeout: float | httpx.Timeout | None | NotGiven = not_given,) -> DeviceCreateResponse:
        """
    ...
    *,
    ...
    extra_query: Query | None = None,
    extra_body: Body | None = None,
    timeout: float | httpx.Timeout | None | NotGiven = not_given,) -> DeviceRetrieveResponse:
        """
    ...
    *,
    ...
    state: Optional[List[Literal["creating", "assigned", "ready", "rebooting", "migrating", "resetting", "terminated", "maintenance", "stopped", "unknown"]]] | Omit = omit,
    type: Literal["android_cloud_phone", "dedicated_premium_device", "dedicated_physical_device", "dedicated_ios_device", "dedicated_emulated_device"] | Omit = omit,
    # Use the following arguments if you need to pass additional parameters to the API that aren't available via kwargs.
    # The extra values given here take precedence over values defined on the client or passed to this method.
    extra_headers: Headers | None = None,
    extra_query: Query | None = None,
    extra_body: Body | None = None,
    timeout: float | httpx.Timeout | None | NotGiven = not_given,) -> DeviceListResponse:
        """
    ...
    *,
    ...
    extra_query: Query | None = None,
    extra_body: Body | None = None,
    timeout: float | httpx.Timeout | None | NotGiven = not_given,) -> DeviceCountResponse:
    ...
    *,
    ...
    extra_query: Query | None = None,
    extra_body: Body | None = None,
    timeout: float | httpx.Timeout | None | NotGiven = not_given,) -> DeviceFingerprintResponse:
        """
    ...
    *,
    ...
    extra_query: Query | None = None,
    extra_body: Body | None = None,
    timeout: float | httpx.Timeout | None | NotGiven = not_given,) -> DeviceRetrieveCapabilitiesResponse:
    ...
    *,
    ...
    extra_query: Query | None = None,
    extra_body: Body | None = None,
    timeout: float | httpx.Timeout | None | NotGiven = not_given,) -> DeviceSetNameResponse:
        """
        ...
        return self._put(
            ...
            body=maybe_transform({
                "name": name
            }, device_set_name_params.DeviceSetNameParams),
            options=make_request_options(extra_headers=extra_headers, extra_query=extra_query, extra_body=extra_body, timeout=timeout),
    ...
    *,
    ...
    extra_query: Query | None = None,
    extra_body: Body | None = None,
    timeout: float | httpx.Timeout | None | NotGiven = not_given,) -> DeviceWaitReadyResponse:
        """
...
class AsyncDevicesResource(AsyncAPIResource):
    ...
    *,
    ...
    async def retrieve_capabilities(self,
    device_id: str,
    *,
    # Use the following arguments if you need to pass additional parameters to the API that aren't available via kwargs.
    # The extra values given here take precedence over values defined on the client or passed to this method.
