...
from ..._utils import path_template, strip_not_given, is_given, maybe_transform, required_args, async_maybe_transform
...
from ...types.devices import app_list_params
from ...types.devices import app_install_params
from ...types.devices import app_start_params
from ...types.devices import app_stop_params
...
class AppsResource(SyncAPIResource):
    ...
    *,
    ...
    timeout: float | httpx.Timeout | None | NotGiven = not_given,) -> None:
        ...
        if not permission:
          raise ValueError(
            f'Expected a non-empty value for `permission` but received {permission!r}'
          )
        extra_headers = {"Accept": "*/*", **(extra_headers or {})}
        extra_headers = { **strip_not_given({
            "X-Device-Display-ID": str(x_device_display_id) if is_given(x_device_display_id) else not_given
        ...
        return self._put(
            path_template("/devices/{device_id}/apps/{package_name}/permissions/{permission}", device_id=device_id, package_name=package_name, permission=permission),
            options=make_request_options(extra_headers=extra_headers, extra_query=extra_query, extra_body=extra_body, timeout=timeout),
            cast_to=NoneType,
        )
    ...
    *,
    ...
    extra_query: Query | None = None,
    extra_body: Body | None = None,
    timeout: float | httpx.Timeout | None | NotGiven = not_given,) -> AppListInstallsResponse:
        """
    ...
    *,
    ...
    timeout: float | httpx.Timeout | None | NotGiven = not_given,) -> None:
        ...
        return self._put(
            ...
            body=maybe_transform({
                "activity": activity
            }, app_start_params.AppStartParams),
            options=make_request_options(extra_headers=extra_headers, extra_query=extra_query, extra_body=extra_body, timeout=timeout),
            cast_to=NoneType,
        )
