...
from ....types.devices.esim import apn_select_params
from ....types.devices.esim import apn_set_params
...
class ApnResource(SyncAPIResource):
    ...
    *,
    ...
    timeout: float | httpx.Timeout | None | NotGiven = not_given,) -> Optional[ApnListResponse]:
        """
