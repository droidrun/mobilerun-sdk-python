...
class RecordingsResource(SyncAPIResource):
    ...
    ) -> Optional[RecordingListResponse]:
        """
    ...
    def trajectory(
        ...
        *,
        ...
        return self._get(
            path_template(
                "/devices/{device_id}/recordings/{recording_id}/trajectory",
                device_id=device_id,
    ...
    def video(
        ...
        *,
        ...
        return self._get(
            path_template(
                "/devices/{device_id}/recordings/{recording_id}/video", device_id=device_id, recording_id=recording_id
            ),
            options=make_request_options(
                extra_headers=extra_headers, extra_query=extra_query, extra_body=extra_body, timeout=timeout
            ),
