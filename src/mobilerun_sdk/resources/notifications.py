...
from .._types import NotGiven, SequenceNotStr
...
class NotificationsResource(SyncAPIResource):
    ...
    *,
    ...
    timeout: float | httpx.Timeout | None | NotGiven = not_given,) -> NotificationCatalogResponse:
    ...
    *,
    ...
    extra_query: Query | None = None,
    extra_body: Body | None = None,
    timeout: float | httpx.Timeout | None | NotGiven = not_given,) -> NotificationGetPreferencesResponse:
        """
    ...
    *,
    ...
    extra_query: Query | None = None,
    extra_body: Body | None = None,
    timeout: float | httpx.Timeout | None | NotGiven = not_given,) -> NotificationUpdatePreferencesResponse:
        ...
        return self._patch(
            ...
            }, notification_update_preferences_params.NotificationUpdatePreferencesParams),
            options=make_request_options(extra_headers=extra_headers, extra_query=extra_query, extra_body=extra_body, timeout=timeout),
