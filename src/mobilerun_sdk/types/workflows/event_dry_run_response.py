...
__all__ = ["EventDryRunResponse", "Data", "DataMatchedFlow", "DataMatchedFlowAction", "DataMatchedFlowFlow", "DataMatchedFlowGates", "DataMatchedFlowTrigger", "DataValidation", "DataValidationError"]
...
class DataMatchedFlowFlow(BaseModel):
    ...
    last_failure_code: Optional[Literal["device_not_found", "permission_denied", "client_error", "transient", "logic", "invalid_config"]] = FieldInfo(alias = "lastFailureCode", default = None)
