...
from mobilerun_sdk.types.workflows import execution_list_params
from mobilerun_sdk.types.workflows import execution_get_metrics_params
...
class TestExecutions:
    ...
    def test_method_abort(self, client: Mobilerun) -> None:
        execution = client.workflows.executions.abort(
            "182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
        )
        assert_matches_type(ExecutionAbortResponse, execution, path=['response'])

    @pytest.mark.skip(reason="Mock server tests are disabled")
    @parametrize
    def test_raw_response_abort(self, client: Mobilerun) -> None:

        response = client.workflows.executions.with_raw_response.abort(
            "182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
        )
    ...
    def test_streaming_response_abort(self, client: Mobilerun) -> None:
        with client.workflows.executions.with_streaming_response.abort(
            "182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
        ) as response :
            assert not response.is_closed
            assert response.http_request.headers.get('X-Stainless-Lang') == 'python'
    ...
    @pytest.mark.skip(reason="Mock server tests are disabled")
    @parametrize
    def test_path_params_abort(self, client: Mobilerun) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `execution_id` but received ''"):
          client.workflows.executions.with_raw_response.abort(
              "",
          )
...
class TestAsyncExecutions:
    ...
    async def test_method_abort(self, async_client: AsyncMobilerun) -> None:
        execution = await async_client.workflows.executions.abort(
            "182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
        )
        assert_matches_type(ExecutionAbortResponse, execution, path=['response'])
    ...
    async def test_raw_response_abort(self, async_client: AsyncMobilerun) -> None:
        ...
        response = await async_client.workflows.executions.with_raw_response.abort(
            "182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
        )
    ...
    async def test_streaming_response_abort(self, async_client: AsyncMobilerun) -> None:
        async with async_client.workflows.executions.with_streaming_response.abort(
            "182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
        ) as response :
            assert not response.is_closed
            assert response.http_request.headers.get('X-Stainless-Lang') == 'python'
    ...
    @pytest.mark.skip(reason="Mock server tests are disabled")
    @parametrize
    async def test_path_params_abort(self, async_client: AsyncMobilerun) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `execution_id` but received ''"):
          await async_client.workflows.executions.with_raw_response.abort(
              "",
          )
