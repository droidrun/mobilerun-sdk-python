...
class TestTime:
    ...
    @parametrize
    def test_method_set_time(self, client: Mobilerun) -> None:
        time = client.devices.time.set_time(
            device_id="deviceId",
    ...
    @pytest.mark.skip(reason="Mock server tests are disabled")
    @parametrize
    def test_method_set_time_with_all_params(self, client: Mobilerun) -> None:
        time = client.devices.time.set_time(
            device_id="deviceId",
            time=parse_datetime("2019-12-27T18:11:19.117Z"),
    ...
    @pytest.mark.skip(reason="Mock server tests are disabled")
    @parametrize
    def test_raw_response_set_time(self, client: Mobilerun) -> None:
        response = client.devices.time.with_raw_response.set_time(
            device_id="deviceId",
            time=parse_datetime("2019-12-27T18:11:19.117Z"),
        )
    ...
    @pytest.mark.skip(reason="Mock server tests are disabled")
    @parametrize
    def test_streaming_response_set_time(self, client: Mobilerun) -> None:
        with client.devices.time.with_streaming_response.set_time(
            device_id="deviceId",
            time=parse_datetime("2019-12-27T18:11:19.117Z"),
        ) as response:
    ...
    @pytest.mark.skip(reason="Mock server tests are disabled")
    @parametrize
    def test_path_params_set_time(self, client: Mobilerun) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `device_id` but received ''"):
            client.devices.time.with_raw_response.set_time(
                device_id="",
                time=parse_datetime("2019-12-27T18:11:19.117Z"),
            )
...
class TestAsyncTime:
    ...
    @pytest.mark.skip(reason="Mock server tests are disabled")
    @parametrize
    async def test_method_set_time(self, async_client: AsyncMobilerun) -> None:
        time = await async_client.devices.time.set_time(
            device_id="deviceId",
            time=parse_datetime("2019-12-27T18:11:19.117Z"),
        )
        assert time is None
    ...
    @pytest.mark.skip(reason="Mock server tests are disabled")
    @parametrize
    async def test_method_set_time_with_all_params(self, async_client: AsyncMobilerun) -> None:
        time = await async_client.devices.time.set_time(
            device_id="deviceId",
            time=parse_datetime("2019-12-27T18:11:19.117Z"),
            x_device_display_id=0,
    ...
    @pytest.mark.skip(reason="Mock server tests are disabled")
    @parametrize
    async def test_raw_response_set_time(self, async_client: AsyncMobilerun) -> None:
        response = await async_client.devices.time.with_raw_response.set_time(
            device_id="deviceId",
            time=parse_datetime("2019-12-27T18:11:19.117Z"),
        )
    ...
    @pytest.mark.skip(reason="Mock server tests are disabled")
    @parametrize
    async def test_streaming_response_set_time(self, async_client: AsyncMobilerun) -> None:
        async with async_client.devices.time.with_streaming_response.set_time(
            device_id="deviceId",
            time=parse_datetime("2019-12-27T18:11:19.117Z"),
        ) as response:
            assert not response.is_closed
    ...
    @pytest.mark.skip(reason="Mock server tests are disabled")
    @parametrize
    async def test_path_params_set_time(self, async_client: AsyncMobilerun) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `device_id` but received ''"):
            await async_client.devices.time.with_raw_response.set_time(
                device_id="",
                time=parse_datetime("2019-12-27T18:11:19.117Z"),
            )
