...
class TestLocation:
    ...
    def test_method_retrieve(self, client: Mobilerun) -> None:
        location = client.devices.location.retrieve(
            device_id="deviceId",
        )
    ...
    def test_raw_response_retrieve(self, client: Mobilerun) -> None:
        response = client.devices.location.with_raw_response.retrieve(
            device_id="deviceId",
        )
    ...
    def test_streaming_response_retrieve(self, client: Mobilerun) -> None:
        with client.devices.location.with_streaming_response.retrieve(
            device_id="deviceId",
        ) as response:
    ...
    def test_path_params_retrieve(self, client: Mobilerun) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `device_id` but received ''"):
            client.devices.location.with_raw_response.retrieve(
                device_id="",
            )
    ...
    def test_method_update(self, client: Mobilerun) -> None:
        location = client.devices.location.update(
            device_id="deviceId",
            latitude=0,
            longitude=0,
        )
    ...
    def test_raw_response_update(self, client: Mobilerun) -> None:
        response = client.devices.location.with_raw_response.update(
            device_id="deviceId",
            latitude=0,
            longitude=0,
        )
    ...
    def test_streaming_response_update(self, client: Mobilerun) -> None:
        with client.devices.location.with_streaming_response.update(
            device_id="deviceId",
            latitude=0,
            longitude=0,
        ) as response:
    ...
    def test_path_params_update(self, client: Mobilerun) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `device_id` but received ''"):
            client.devices.location.with_raw_response.update(
                device_id="",
                latitude=0,
                longitude=0,
            )
...
class TestAsyncLocation:
    ...
    async def test_method_retrieve(self, async_client: AsyncMobilerun) -> None:
        location = await async_client.devices.location.retrieve(
            device_id="deviceId",
        )
        assert_matches_type(LocationRetrieveResponse, location, path=["response"])
    ...
    async def test_raw_response_retrieve(self, async_client: AsyncMobilerun) -> None:
        response = await async_client.devices.location.with_raw_response.retrieve(
            device_id="deviceId",
        )
    ...
    async def test_streaming_response_retrieve(self, async_client: AsyncMobilerun) -> None:
        async with async_client.devices.location.with_streaming_response.retrieve(
            device_id="deviceId",
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    async def test_path_params_retrieve(self, async_client: AsyncMobilerun) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `device_id` but received ''"):
            await async_client.devices.location.with_raw_response.retrieve(
                device_id="",
            )
    ...
    async def test_method_update(self, async_client: AsyncMobilerun) -> None:
        location = await async_client.devices.location.update(
            device_id="deviceId",
            latitude=0,
            longitude=0,
        )
    ...
    async def test_raw_response_update(self, async_client: AsyncMobilerun) -> None:
        response = await async_client.devices.location.with_raw_response.update(
            device_id="deviceId",
            latitude=0,
            longitude=0,
        )
    ...
    async def test_streaming_response_update(self, async_client: AsyncMobilerun) -> None:
        async with async_client.devices.location.with_streaming_response.update(
            device_id="deviceId",
            latitude=0,
            longitude=0,
        ) as response:
    ...
    async def test_path_params_update(self, async_client: AsyncMobilerun) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `device_id` but received ''"):
            await async_client.devices.location.with_raw_response.update(
                device_id="",
                latitude=0,
                longitude=0,
            )
