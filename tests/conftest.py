...
from mobilerun_sdk import Mobilerun, DefaultAioHttpClient, AsyncMobilerun
...
async def async_client(request: FixtureRequest) -> AsyncIterator[AsyncMobilerun]:
    ...
    async with AsyncMobilerun(base_url=base_url, api_key=api_key, _strict_response_validation=strict, http_client=http_client) as client :
        yield client