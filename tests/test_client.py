...
class TestDroidrunCloud:
            ...
            for frame in diff.traceback:
                if any(
                    ...
                    for fragment in [
                        ...
                        "droidrun_cloud/_legacy_response.py",
                        "droidrun_cloud/_response.py",
                        # pydantic.BaseModel.model_dump || pydantic.BaseModel.dict leak memory for some reason.
                        "droidrun_cloud/_compat.py",
    ...
    def test_retrying_timeout_errors_doesnt_leak(self, respx_mock: MockRouter, client: DroidrunCloud) -> None:
        ...
        with pytest.raises(APITimeoutError):
            client.tasks.with_streaming_response.run(task="x").__enter__()
    ...
    def test_retries_taken(
        ...
        response = client.tasks.with_raw_response.run(task="x")
    ...
    def test_omit_retry_count_header(
        ...
        response = client.tasks.with_raw_response.run(task="x", extra_headers={"x-stainless-retry-count": Omit()})
    ...
    def test_overwrite_retry_count_header(
        ...
        response = client.tasks.with_raw_response.run(task="x", extra_headers={"x-stainless-retry-count": "42"})
...
class TestAsyncDroidrunCloud:
    ...
    async def test_retrying_timeout_errors_doesnt_leak(
        ...
        with pytest.raises(APITimeoutError):
            await async_client.tasks.with_streaming_response.run(task="x").__aenter__()
    ...
    async def test_retries_taken(
        ...
        response = await client.tasks.with_raw_response.run(task="x")
    ...
    async def test_omit_retry_count_header(
        ...
        response = await client.tasks.with_raw_response.run(task="x", extra_headers={"x-stainless-retry-count": Omit()})
    ...
    async def test_overwrite_retry_count_header(
        ...
        response = await client.tasks.with_raw_response.run(task="x", extra_headers={"x-stainless-retry-count": "42"})
