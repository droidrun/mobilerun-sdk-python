...
from mobilerun_sdk._exceptions import APITimeoutError, APIStatusError, APIResponseValidationError
...
from mobilerun_sdk._types import Omit

from pydantic import ValidationError

from mobilerun_sdk._base_client import DefaultHttpxClient, get_platform, OtherPlatform, DefaultAsyncHttpxClient

from mobilerun_sdk._utils import asyncify
...
from mobilerun_sdk import Mobilerun, AsyncMobilerun, APIResponseValidationError
from mobilerun_sdk._models import FinalRequestOptions, BaseModel
from mobilerun_sdk._types import Headers, Query, Body, Timeout, Omit
from mobilerun_sdk._base_client import DEFAULT_TIMEOUT, HTTPX_DEFAULT_TIMEOUT, BaseClient, RequestOptions, make_request_options
from mobilerun_sdk._streaming import Stream, AsyncStream
from mobilerun_sdk._constants import RAW_RESPONSE_HEADER
from mobilerun_sdk._response import APIResponse, AsyncAPIResponse
from mobilerun_sdk._types import Omit
...
class TestMobilerun:
    ...
    def test_copy_default_headers(self) -> None:
        client = Mobilerun(base_url=base_url, api_key=api_key, _strict_response_validation=True, default_headers={
            "X-Foo": "bar"
        })
    ...
    def test_copy_default_query(self) -> None:
        client = Mobilerun(base_url=base_url, api_key=api_key, _strict_response_validation=True, default_query={
            "foo": "bar"
        })
            ...
            for frame in diff.traceback:
                if any(
                    ...
                    for fragment in [
                        ...
                        "mobilerun_sdk/_legacy_response.py",
                        "mobilerun_sdk/_response.py",
                        # pydantic.BaseModel.model_dump || pydantic.BaseModel.dict leak memory for some reason.
                        "mobilerun_sdk/_compat.py",
    ...
    def test_client_timeout_option(self) -> None:
        client = Mobilerun(base_url=base_url, api_key=api_key, _strict_response_validation=True, timeout=httpx.Timeout(0))
    ...
    def test_http_client_timeout_option(self) -> None:
        ...
        with httpx.Client(timeout=None) as http_client:
          client = Mobilerun(base_url=base_url, api_key=api_key, _strict_response_validation=True, http_client=http_client)
    ...
    async def test_invalid_http_client(self) -> None:
        with pytest.raises(TypeError, match='Invalid `http_client` arg') :
            async with httpx.AsyncClient() as http_client :
                Mobilerun(base_url=base_url, api_key=api_key, _strict_response_validation=True, http_client=cast(Any, http_client))

    def test_default_headers_option(self) -> None:
        test_client = Mobilerun(base_url=base_url, api_key=api_key, _strict_response_validation=True, default_headers={
            "X-Foo": "bar"
        })
        ...
        test_client2 = Mobilerun(base_url=base_url, api_key=api_key, _strict_response_validation=True, default_headers={
            "X-Foo": "stainless",
    ...
    def test_hardcoded_query_params_in_url(self, client: Mobilerun) -> None:
    ...
    def test_binary_content_upload_with_iterator(self) -> None:
        ...
        with Mobilerun(base_url=base_url, api_key=api_key, _strict_response_validation=True, http_client=httpx.Client(transport = MockTransport(handler=mock_handler))) as client:
    ...
    @pytest.mark.parametrize("client", [Mobilerun(base_url="http://localhost:5000/custom/path/", api_key=api_key, _strict_response_validation=True), Mobilerun(base_url="http://localhost:5000/custom/path/", api_key=api_key, _strict_response_validation=True, http_client=httpx.Client())], ids = ["standard", "custom http client"])
    ...
    def test_parse_retry_after_header(self, remaining_retries: int, retry_after: str, timeout: float, client: Mobilerun) -> None:
        headers = httpx.Headers({"retry-after": retry_after})
        options = FinalRequestOptions(method="get", url="/foo", max_retries=3)
        calculated = client._calculate_retry_timeout(remaining_retries, options, headers)
        assert calculated == pytest.approx(timeout, 0.5 * 0.875) # pyright: ignore[reportUnknownMemberType]

    @mock.patch("mobilerun_sdk._base_client.BaseClient._calculate_retry_timeout", _low_retry_timeout)
    @pytest.mark.respx(base_url=base_url)
    def test_retrying_timeout_errors_doesnt_leak(self, respx_mock: MockRouter, client: Mobilerun) -> None:
        ...
        with pytest.raises(APITimeoutError):
            client.devices.with_streaming_response.list().__enter__()
...
class TestAsyncMobilerun:
    ...
    async def test_copy_default_headers(self) -> None:
        client = AsyncMobilerun(base_url=base_url, api_key=api_key, _strict_response_validation=True, default_headers={
            "X-Foo": "bar"
        })
        assert client.default_headers['X-Foo'] == 'bar'
    ...
    async def test_copy_default_query(self) -> None:
        client = AsyncMobilerun(base_url=base_url, api_key=api_key, _strict_response_validation=True, default_query={
            "foo": "bar"
        })
        assert _get_params(client)['foo'] == 'bar'
    ...
    async def test_client_timeout_option(self) -> None:
        client = AsyncMobilerun(base_url=base_url, api_key=api_key, _strict_response_validation=True, timeout=httpx.Timeout(0))
    ...
    async def test_http_client_timeout_option(self) -> None:
        ...
        async with httpx.AsyncClient(timeout=None) as http_client:
          client = AsyncMobilerun(base_url=base_url, api_key=api_key, _strict_response_validation=True, http_client=http_client)
    ...
    def test_invalid_http_client(self) -> None:
        with pytest.raises(TypeError, match='Invalid `http_client` arg') :
            with httpx.Client() as http_client :
                AsyncMobilerun(base_url=base_url, api_key=api_key, _strict_response_validation=True, http_client=cast(Any, http_client))

    async def test_default_headers_option(self) -> None:
        test_client = AsyncMobilerun(base_url=base_url, api_key=api_key, _strict_response_validation=True, default_headers={
            "X-Foo": "bar"
        })
        request = test_client._build_request(FinalRequestOptions(method="get", url='/foo'))
        assert request.headers.get('x-foo') == 'bar'
        ...
        test_client2 = AsyncMobilerun(base_url=base_url, api_key=api_key, _strict_response_validation=True, default_headers={
            "X-Foo": "stainless",
            "X-Stainless-Lang": "my-overriding-header",
        })
        request = test_client2._build_request(FinalRequestOptions(method="get", url='/foo'))
    ...
    async def test_hardcoded_query_params_in_url(self, async_client: AsyncMobilerun) -> None:
    ...
    async def test_binary_content_upload_with_asynciterator(self) -> None:
        ...
        async with AsyncMobilerun(base_url=base_url, api_key=api_key, _strict_response_validation=True, http_client=httpx.AsyncClient(transport = MockTransport(handler=mock_handler))) as client:
    ...
    @pytest.mark.respx(base_url=base_url)
    async def test_binary_content_upload_with_body_is_deprecated(self, respx_mock: MockRouter, async_client: AsyncMobilerun) -> None:
        respx_mock.post("/upload").mock(side_effect=mirror_request_content)
    ...
    @pytest.mark.respx(base_url=base_url)
    async def test_non_application_json_content_type_for_json_data(self, respx_mock: MockRouter, async_client: AsyncMobilerun) -> None:
        """
        Response that sets Content-Type to something other than application/json but returns json data
        """
        class Model(BaseModel):
    ...
    async def test_base_url_setter(self) -> None:
        client = AsyncMobilerun(base_url="https://example.com/from_init", api_key=api_key, _strict_response_validation=True)
        assert client.base_url == "https://example.com/from_init/"
    ...
    @pytest.mark.parametrize("client", [AsyncMobilerun(base_url="http://localhost:5000/custom/path/", api_key=api_key, _strict_response_validation=True), AsyncMobilerun(base_url="http://localhost:5000/custom/path/", api_key=api_key, _strict_response_validation=True, http_client=httpx.AsyncClient())], ids = ["standard", "custom http client"])
    ...
    async def test_client_max_retries_validation(self) -> None:
        with pytest.raises(TypeError, match=r"max_retries cannot be None"):
          AsyncMobilerun(base_url=base_url, api_key=api_key, _strict_response_validation=True, max_retries=cast(Any, None))
    ...
    @mock.patch("time.time", mock.MagicMock(return_value=1696004797))
    async def test_parse_retry_after_header(self, remaining_retries: int, retry_after: str, timeout: float, async_client: AsyncMobilerun) -> None:
        headers = httpx.Headers({"retry-after": retry_after})
        options = FinalRequestOptions(method="get", url="/foo", max_retries=3)
    ...
    @mock.patch("mobilerun_sdk._base_client.BaseClient._calculate_retry_timeout", _low_retry_timeout)
    @pytest.mark.respx(base_url=base_url)
    async def test_retrying_timeout_errors_doesnt_leak(self, respx_mock: MockRouter, async_client: AsyncMobilerun) -> None:
        respx_mock.get("/devices").mock(side_effect=httpx.TimeoutException("Test timeout error"))

        with pytest.raises(APITimeoutError):
            await async_client.devices.with_streaming_response.list().__aenter__()

        assert _get_open_connections(async_client) == 0

    @mock.patch("mobilerun_sdk._base_client.BaseClient._calculate_retry_timeout", _low_retry_timeout)
    @pytest.mark.respx(base_url=base_url)
    async def test_retrying_status_errors_doesnt_leak(self, respx_mock: MockRouter, async_client: AsyncMobilerun) -> None:
        respx_mock.get("/devices").mock(return_value=httpx.Response(500))
